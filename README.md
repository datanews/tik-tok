...
* If you aren't familiar with those technologies, just [download](https://github.com/datanews/tik-tok/archive/0.0.1.zip) the code directly from Github and separately download the dependencies, [Underscore](http://underscorejs.org/) and [Moment.js](http://momentjs.com/docs/).
...
Or, the full CDN version:
    ...
    <link href="https://cdn.rawgit.com/datanews/tik-tok/0.0.1/dist/tik-tok.min.css" rel="stylesheet" type="text/css">
    <script src="https://cdn.rawgit.com/datanews/tik-tok/0.0.1/dist/tik-tok.min.js"></script>
